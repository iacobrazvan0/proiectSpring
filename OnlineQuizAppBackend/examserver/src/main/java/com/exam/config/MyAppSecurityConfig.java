...
public class MyAppSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
				...
				.disable()
				.authorizeRequests()
				.antMatchers("/generate-token", "/user/**").permitAll()  // Permite accesul la login și register
				.antMatchers("/ws/**").permitAll()  // Permite accesul WebSocket
				.antMatchers(HttpMethod.OPTIONS).permitAll()  // Permite opțiuni CORS
